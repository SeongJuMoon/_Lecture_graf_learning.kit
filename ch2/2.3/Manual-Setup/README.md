...
|------|---------|----------|-----|----------|-----|--------|
| Control Plane | cp-k8s-1.30.4 | cp-k8s | 192.168.1.10 | 60010 | 2 | 2048MB |
| Worker 1 | w1-k8s-1.30.4 | w1-k8s | 192.168.1.101 | 60101 | 1 | 2048MB |
| Worker 2 | w2-k8s-1.30.4 | w2-k8s | 192.168.1.102 | 60102 | 1 | 2048MB |
| Worker 3 | w3-k8s-1.30.4 | w3-k8s | 192.168.1.103 | 60103 | 1 | 2048MB |

**VirtualBox 그룹**: `/Grafana-k8s-U1.30.4-ctrd-1.6(manual)`
...
vagrant up cp-k8s-1.30.4
vagrant up w1-k8s-1.30.4
vagrant up w2-k8s-1.30.4
vagrant up w3-k8s-1.30.4
...
```cmd
:: Control Plane
vagrant upload k8s_env_build.sh /home/vagrant/k8s_env_build.sh cp-k8s-1.30.4
vagrant upload k8s_pkg_cfg.sh /home/vagrant/k8s_pkg_cfg.sh cp-k8s-1.30.4
vagrant upload controlplane_node.sh /home/vagrant/controlplane_node.sh cp-k8s-1.30.4
vagrant upload extra_k8s_pkgs.sh /home/vagrant/extra_k8s_pkgs.sh cp-k8s-1.30.4

:: Worker 1
vagrant upload k8s_env_build.sh /home/vagrant/k8s_env_build.sh w1-k8s-1.30.4
vagrant upload k8s_pkg_cfg.sh /home/vagrant/k8s_pkg_cfg.sh w1-k8s-1.30.4
vagrant upload worker_nodes.sh /home/vagrant/worker_nodes.sh w1-k8s-1.30.4

:: Worker 2
vagrant upload k8s_env_build.sh /home/vagrant/k8s_env_build.sh w2-k8s-1.30.4
vagrant upload k8s_pkg_cfg.sh /home/vagrant/k8s_pkg_cfg.sh w2-k8s-1.30.4
vagrant upload worker_nodes.sh /home/vagrant/worker_nodes.sh w2-k8s-1.30.4

:: Worker 3
vagrant upload k8s_env_build.sh /home/vagrant/k8s_env_build.sh w3-k8s-1.30.4
vagrant upload k8s_pkg_cfg.sh /home/vagrant/k8s_pkg_cfg.sh w3-k8s-1.30.4
vagrant upload worker_nodes.sh /home/vagrant/worker_nodes.sh w3-k8s-1.30.4
```
...
sudo ./k8s_pkg_cfg.sh 1.30.4-1.1 1.6.31-1 CP
sudo ./controlplane_node.sh 1.30.4
```
...
chmod +x *.sh
sudo ./k8s_env_build.sh 3 1.30
sudo ./k8s_pkg_cfg.sh 1.30.4-1.1 1.6.31-1 W
...
cp-k8s   Ready    control-plane   10m   v1.30.4
w1-k8s   Ready    <none>          5m    v1.30.4
w2-k8s   Ready    <none>          3m    v1.30.4
w3-k8s   Ready    <none>          1m    v1.30.4
```
...
```cmd
vagrant reload cp-k8s-1.30.4
vagrant reload w1-k8s-1.30.4 w2-k8s-1.30.4 w3-k8s-1.30.4
```

### 특정 VM만 다시 생성

```cmd
vagrant destroy w1-k8s-1.30.4 -f
vagrant up w1-k8s-1.30.4
...
- _Lecture_graf_learning.kit 저장소 클론
- rerepo-graf_learning.kit 스크립트 생성
